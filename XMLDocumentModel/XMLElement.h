...
namespace XMLDocumentModel
{
	...
	inline std::vector<std::shared_ptr<AbstractXmlElement>> AbstractXmlElement::children() { std::vector<std::shared_ptr<AbstractXmlElement>> child; return child; }
	inline std::vector<std::pair<std::string, std::string>> AbstractXmlElement::attributes() { std::vector<std::pair<std::string, std::string>> child; return child; }
